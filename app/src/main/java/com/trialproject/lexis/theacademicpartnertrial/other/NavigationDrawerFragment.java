...
public class NavigationDrawerFragment extends Fragment {
    ...
    private RecViewAdpater adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter=new RecViewAdpater(getActivity(), getData());
        recyclerView.setAdapter(adapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        return layout;
    }

    public static List<ViewInfo> getData(){
        List<ViewInfo> data=new ArrayList<>();
        int[] icons={R.mipmap.ic_launcher, R.mipmap.ic_launcher, R.mipmap.ic_launcher, R.mipmap.ic_launcher};
        String[] titles = {"Text", "Text", "Text", "Text"};
        for (int i=0; i<titles.length && i<icons.length; i++){
            ViewInfo current=new ViewInfo();
